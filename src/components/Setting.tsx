      ...
      <Show when={shown()}>
        ...
        <div class="flex items-center hover:text-slate-3 mt-2 justify-between">
          <div class="flex items-center">
            ...
            <span ml-1>System role command</span>
          </div>
          <input
            type="text"
        ...
        <div class="flex items-center hover:text-slate-3 mt-2 justify-between">
          <div class="flex items-center">
            ...
            <span ml-1>Divergence of thinking</span>
          </div>
          <input
            type="range"
            min={0}
        ...
        <div class="flex items-center hover:text-slate-3 mt-2 justify-between">
          <div class="flex items-center">
            ...
            <span ml-1>Record the content of the conversation, refresh will not disappear</span>
          </div>
        ...
        <div class="flex items-center hover:text-slate-3 mt-2 justify-between">
          <div class="flex items-center">
            ...
            <span ml-1>Opening a continuous dialogue will double the consumption of Token</span>
          </div>
          <label class="relative inline-flex items-center cursor-pointer ml-1">
            <input
              type="checkbox"
